        ...
        <Row gutter={[32, 32]} align="middle">
          ...
          <Col xs={24} lg={12}>
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-secondary text-sm lg:text-base max-w-md mx-auto lg:mx-0">
              ...
              <Button
                ...
                className="bg-[#16A1FF] text-white px-6 py-2 rounded-xl font-semibold text-sm shadow-md"
              >
                Start for free
              </Button>
            </div>
