...
function CoursePage() {
  ...
  return (
    <div className="bg-default">
      ...
      {/*course Start*/}
      <div className="w-full px-4 md:px-20 md:py-20 py-14">
        <div className="flex flex-col gap-4 justify-center items-center">
          <div className="text-3xl font-bold text-white">
            Courses to get you started
          </div>
          <div className="text-[#637381] mt-1">
            Explore courses curated by industry experts with real-world experience.
          </div>
          <CourseTab
      ...
      <div
        className="background: linear-gradient(92.2deg, rgba(47, 87, 239, 0.2) 0%, rgba(255, 177, 69, 0.2) 100.43%);
              ...
              <div className="relative w-1/2 sm:w-auto" ref={filterRef}>
                ...
                {isFilterOpen && (
                  <div className="absolute top-full left-0 sm:left-auto sm:right-0 mt-1 bg-paper shadow-lg rounded-lg py-2 w-full sm:w-48 z-20">
                    <div
                      className="px-3 py-2 text-white hover:bg-gray-100 cursor-pointer"
